...
@section('content')
        ...
        <div class="hero-container">
            <div class="hero-content">
                <div class="content-wrapper" data-aos="fade-up" data-aos-delay="100">
                    <h1 class="hero-title">Descubre productos increíbles</h1>
                    <p class="hero-description">Descubre nuestra exclusiva colección de artículos prémium diseñados para
                        mejorar tu estilo de vida. Desde moda hasta tecnología, encuentra todo lo que necesitas con ofertas
                        exclusivas y envío rápido.
                    </p>
                        ...
                        <div class="product-item">
                            <div class="product-image">
                                @php
                                    ...
                                    $imagen =
                                        $imagen_producto && $imagen_producto->imagen
                                            ? asset('storage/' . $imagen_producto->imagen)
                                            : asset('assets/img/no-image.jpg');
                                @endphp
                                <img src="{{ $imagen }}" alt="Imagen del producto" class="img-fluid" loading="lazy">
                                <div class="product-actions">
                                    <button class="action-btn wishlist-btn">
                                        <i class="bi bi-heart"></i>
                                    </button>
                                    <a href="{{ route('web.detalle_producto', $producto->id) }}" class="action-btn quickview-btn">
                            ...
                            <div class="product-info">
                                ...
                                <h4 class="product-name"><a
                                        href="{{ route('web.detalle_producto', $producto->id) }}">{{ $producto->descripcion_corta }}</a></h4>
            ...
            @if ($productos->hasPages())
                <div class="d-flex justify-content-between align-items-center mt4 px-3">
                    <div class="text-muted">
                        Mostrando de {{ $productos->firstItem() }} a {{ $productos->lastItem() }} de
    ...
    </section><!-- /explora nuestros productos Section -->
@stop
