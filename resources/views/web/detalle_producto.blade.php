                    ...
                    <div class="product-gallery">
                        <div class="main-showcase">
                            <div class="image-zoom-container">
                                ...
                                @endphp
                                <img src="{{$imagen}}" alt="Product Main"
                    ...
                    <div class="product-details">
                        ...
                        <div class="purchase-section">
                            ...
                            <div class="action-buttons">
                                <a href="{{ route('web.carrito')}}" class="btn primary-action">
                                    <i class="bi bi-bag-plus"></i>
                                    Agregar al Carrito
                                </a>
                                <a href="{{ route('web.dashboard')}}" class="btn icon-action" title="Add to Wishlist">
                    ...
                    <div class="info-tabs-container">
                        <nav class="tabs-navigation nav">
                            <button class="nav-link active" data-bs-toggle="tab"
                                data-bs-target="#ecommerce-product-details-5-overview" type="button">Descripción del Producto</button>
