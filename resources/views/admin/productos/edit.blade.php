    ...
    <div class="row">
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <div class="card-header bg-warning text-dark py-3">
                <h5 class="mb-0"><i class="bi bi-pencil me-2"></i> Modifique los datos del producto: {{ $producto->nombre }}</h5>
            </div>

            <div class="card-body bg-light">
                <form action="{{ route('admin.productos.update', $producto->id) }}" method="POST" class="p-3">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group shadow-sm">
                                ...
                                <textarea name="descripcion_corta" id="descripcion_corta" class="form-control border-0" rows="3"
                                    placeholder="Breve descripción...">{{ old('descripcion_corta', $producto->descripcion_corta) }}</textarea>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="descripcion_larga" id="descripcion_larga" class="form-control shadow-sm border-0"
                                rows="4" placeholder="Detalles completos, especificaciones y características...">{{ old('descripcion_larga', $producto->descripcion_larga) }}</textarea>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <button type="submit" class="btn btn-warning rounded-pill shadow-sm px-4 text-white">
